...
# Homebrew formula for the Fever CLI.
#
# Source: https://github.com/FeverTokens/fever-cli (private)
# Public binary mirror: https://github.com/FeverTokens/fever-cli-releases
# Also published on JSR as @fevertokens/cli.
class Fever < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/FeverTokens/fever-cli-releases/releases/download/v0.1.7/fever-macos-aarch64"
      sha256 "926e5ef02475b31bd2251f2f8aecb102a9aad9615ffd53689065bafc46b9fd28"
    end
    on_intel do
      url "https://github.com/FeverTokens/fever-cli-releases/releases/download/v0.1.7/fever-macos-x86_64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/FeverTokens/fever-cli-releases/releases/download/v0.1.7/fever-linux-aarch64"
      sha256 "8d25adb910e7d35f02382e674b6d9f07d37b33c87d09eab9225d5666ac694c3c"
    end
    on_intel do
      url "https://github.com/FeverTokens/fever-cli-releases/releases/download/v0.1.7/fever-linux-x86_64"
